...
public class Admin implements Serializable {
    ...
    public Date getAdmin_regTime() {
        return admin_regTime;
    }

    public void setAdmin_regTime(Date admin_regTime) {
        this.admin_regTime = admin_regTime;
    }
